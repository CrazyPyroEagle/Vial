...
namespace TestHelper
{
    ...
    public abstract partial class DiagnosticVerifier
    {
        ...
        private static readonly MetadataReference SystemRuntimeReference = MetadataReference.CreateFromFile(typeof(Attribute).Assembly.Location);
        private static readonly MetadataReference CSharpSymbolsReference = MetadataReference.CreateFromFile(typeof(CSharpCompilation).Assembly.Location);
        private static readonly MetadataReference CodeAnalysisReference = MetadataReference.CreateFromFile(typeof(Compilation).Assembly.Location);
        private static readonly MetadataReference VialMixinsReference = MetadataReference.CreateFromFile(typeof(Vial.Mixins.MixinAttribute).Assembly.Location);
        ...
        private static Project CreateProject(string[] sources, string language = LanguageNames.CSharp)
        {
            ...
            Solution solution = new AdhocWorkspace()
                ...
                .AddMetadataReference(projectId, VialMixinsReference);
